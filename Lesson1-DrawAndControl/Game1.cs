...
namespace FirstProject_DrawAndControl
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.Left)) // If we press-down the "left" key, Decreases by one pixel the position of image1 to left each frame.
                positionImage1.X--;
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.A)) // If we press-down the "A" key, Decreases by one pixel the position of image2 to left each frame.
                positionImage2.X--;
